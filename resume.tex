...
/Keywords (testing, unit testing, regression testing, integration testing, automated testing, testing frameworks, Jest, Cucumber, Selenium, Junit, PyTest, Supertest, Puppeteer, TDD, BDD, DDD, clean code, maintainable, scalable, readable, well documented, version control, continuous integration, continuous deployment, CI/CD, Git, Github, Gitlab, Gitflow, Jenkins, Jira, Kafka, RabbitMQ, C#, C#.Net, .Net, .Net core 2 years experience, industry experience, production, developer, engineer, if you are reading this please interview me, im smart, im  a grinder, I  am equally comfortable being left to google it and figure it out myself as I am being guided. I am socially full functional and will occasionally make you laugh.)
}
\end{document}
